...
mpirun -np $n_cpu --allow-run-as-root ./fortran_process -jorek_file jorek00001.h5 -save_pixels -resolution 0.02 -3D_grid > ./jorek_output_data_grid.txt
mpirun -np $n_cpu --allow-run-as-root ./fortran_process -jorek_file jorek00001.h5 -use_pixel_file -variable D_alpha -bin_data -3D_grid > ./jorek_output_data.txt
